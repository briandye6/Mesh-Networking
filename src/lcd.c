...
void LCD_EXTI6_Initialize(void) {
  // Configure PC6 as Input
  RCC->AHBENR |= RCC_AHBENR_GPIOCEN;
  GPIOC->MODER &= ~(3<<12);
  GPIOC->PUPDR |= (GPIO_PuPd_DOWN << 12);

  // Configure SYSCFG
  RCC->APB2ENR |= RCC_APB2ENR_SYSCFGEN;

  // Select PC6 as the trigger source of EXTI1
  ...
  // Disable Falling edge trigger for EXTI6
  EXTI->FTSR &= ~EXTI_FTSR_TR6;

  // Enable EXTI1 interrupt
  EXTI->IMR |= EXTI_IMR_MR6;

  // Set EXTI6 Priority to be 0
